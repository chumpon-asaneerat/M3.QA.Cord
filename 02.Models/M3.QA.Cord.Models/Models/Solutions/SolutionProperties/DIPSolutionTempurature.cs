...
{
    #region DIPSolutionTempurature

    /// <summary>
    /// The DIP Solution Tempurature class.
    /// </summary>
    public class DIPSolutionTempurature : NRTestProperty
    {
        ...
        protected override void CheckSpec()
        {
            ...
            if (null != CalcAvgCallback) CalcAvgCallback("TEMP");
        }
