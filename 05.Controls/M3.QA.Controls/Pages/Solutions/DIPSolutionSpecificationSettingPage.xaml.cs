...
{
    /// <summary>
    /// Interaction logic for DIPSolutionSpecificationSettingPage.xaml
    /// </summary>
    public partial class DIPSolutionSpecificationSettingPage : UserControl
    {
        #region Constructor
        ...
        /// Constructor.
        /// </summary>
        public DIPSolutionSpecificationSettingPage()
        {
            InitializeComponent();
        }
        ...
        private void LoadComboboxes()
        {
            ...
            cordCodes = CordCode.GetsBySolution().Value();
            this.InvokeAction(() =>
            {
